...
# SVM_Linear
mdl = 0
heatmap_inputs['gridLength_GS'][model_names[mdl]] = 20
heatmap_inputs['numZooms_GS'][model_names[mdl]] = 3
heatmap_inputs['numLayers_GS'][model_names[mdl]] = 3
heatmap_inputs['decimal_point_GS'][model_names[mdl]] = 0.1
heatmap_inputs['gridLength_AL'][model_names[mdl]] = 40
heatmap_inputs['num_HP_zones_AL'][model_names[mdl]] = 4
