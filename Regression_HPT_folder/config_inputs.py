...
heatmap_inputs['numLayers_GS'][model_names[mdl]] = 2
heatmap_inputs['decimal_point_GS'][model_names[mdl]] = 0.1
heatmap_inputs['gridLength_AL'][model_names[mdl]] = 10
heatmap_inputs['num_HP_zones_AL'][model_names[mdl]] = 2
heatmap_inputs['num_runs_AL'][model_names[mdl]] = 2
